...
DEFAULT_DK_CLIENT_VERSION = "2615.2.1.13"
DEFAULT_DK_WIDGET_VERSION = "2.9.9"
DEFAULT_DK_COOKIE = (
...
def _headers() -> dict[str, str]:
    headers = {
        ...
        "x-client-version": os.getenv("DK_CLIENT_VERSION", DEFAULT_DK_CLIENT_VERSION),
        "x-client-widget-name": "cms",
        "x-client-widget-version": os.getenv("DK_WIDGET_VERSION", DEFAULT_DK_WIDGET_VERSION),
    }
    cookie = os.getenv("DK_COOKIE", DEFAULT_DK_COOKIE).strip()
    if cookie:
